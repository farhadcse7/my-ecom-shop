                                                ...
                                                <div class="tp-product-item-2 mb-40">
                                                    ...
                                                    <div class="tp-product-content-2 pt-15">
                                                        <div class="tp-product-tag-2">
                                                            <a
                                                                href="{{ route('sub-category', ['id' => $product->subCategory->id]) }}">{{ $product->subCategory->name }}</a>
                                                        </div>
                                                        ...
                                                        <div class="tp-product-price-wrapper-2">
                                                            <span class="tp-product-price-2 new-price">TK.
                                                                {{ $product->selling_price }}</span>
                                                            <span class="tp-product-price-2 old-price">TK.
