                                ...
                                <div class="tp-shop-widget-product">
                                    <div class="tp-shop-widget-product-item d-flex align-items-center">
                                        ...
                                        <div class="tp-shop-widget-product-content">
                                            ...
                                            <h4 class="tp-shop-widget-product-title">
                                                <a href="{{route('product-detail')}}">Smart watches wood...</a>
                                            </h4>
                                    ...
                                    <div class="tp-shop-widget-product-item d-flex align-items-center">
                                        ...
                                        <div class="tp-shop-widget-product-content">
                                            ...
                                            <h4 class="tp-shop-widget-product-title">
                                                <a href="{{route('product-detail')}}">Decoration for panda.</a>
                                            </h4>
                                            <div class="tp-shop-widget-product-price-wrapper">
                                    ...
                                    <div class="tp-shop-widget-product-item d-flex align-items-center">
                                        ...
                                        <div class="tp-shop-widget-product-content">
                                            ...
                                            <h4 class="tp-shop-widget-product-title">
                                                <a href="{{route('product-detail')}}">Trending Watch for Man</a>
                                            </h4>
                                            <div class="tp-shop-widget-product-price-wrapper">
                                    ...
                                    <div class="tp-shop-widget-product-item d-flex align-items-center">
                                        ...
                                        <div class="tp-shop-widget-product-content">
                                            ...
                                            <h4 class="tp-shop-widget-product-title">
                                                <a href="{{route('product-detail')}}">Minimal Backpack.</a>
                                            </h4>
                                            <div class="tp-shop-widget-product-price-wrapper">
                                    ...
                                    <div class="row infinite-container">
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-1.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Whitetails Women's Open Sky</a>
                                                    </h3>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-2.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Simple Modern School Boys</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-3.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Women's Essentials Convertible</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-4.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Calvin Klein Gabrianna Novelty</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-5.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Tommy Hilfiger Women’s Jaden</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-6.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Govicta Men's Shoes Leather</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-7.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Legendary Whitetails Men's.</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-8.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Backpack, School Bag.</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-9.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                        ...
                                        <div class="col-xl-4 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-10.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    ...
                                                    <h3 class="tp-product-title-2">
                                                        <a href="{{route('product-detail')}}">Full Sleeve Shirt(Pink)</a>
                                                    </h3>
                                                    <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="col-xl-4 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-11.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                        ...
                                        <div class="col-xl-4 col-sm-6 infinite-item">
                                            <div class="tp-product-item-2 mb-40">
                                                <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                    <a href="{{route('product-detail')}}">
                                                        <img src="{{asset('/')}}website/assets/img/product/2/prodcut-12.jpg" alt="">
                                                    </a>
                                                    <!-- product action -->
                                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                        <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="tp-product-list-item d-md-flex">
                                                    ...
                                                    <div class="tp-product-list-content">
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <h3 class="tp-product-title-2">
                                                                <a href="{{route('product-detail')}}">Black Leather Bag</a>
                                                            </h3>
                                                            <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                                <span><i class="fa-solid fa-star"></i></span>
                                                                <span><i class="fa-solid fa-star"></i></span>
                                                ...
                                                <div class="tp-product-list-item d-md-flex">
                                                    ...
                                                    <div class="tp-product-list-content">
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <h3 class="tp-product-title-2">
                                                                <a href="{{route('product-detail')}}">Winter Men's Jacket</a>
                                                            </h3>
                                                            <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                                <span><i class="fa-solid fa-star"></i></span>
                                                                <span><i class="fa-solid fa-star"></i></span>
                                                ...
                                                <div class="tp-product-list-item d-md-flex">
                                                    ...
                                                    <div class="tp-product-list-content">
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <h3 class="tp-product-title-2">
                                                                <a href="{{route('product-detail')}}">Full Sleeve Shirt For Men</a>
                                                            </h3>
                                                            <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                                <span><i class="fa-solid fa-star"></i></span>
                                                                <span><i class="fa-solid fa-star"></i></span>
