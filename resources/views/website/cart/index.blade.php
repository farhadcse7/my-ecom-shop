                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="tp-cart-img"><a href="product-details.html"> <img
                                            src="{{ asset('/') }}website/assets/img/product/cart/product-cart-1.jpg"
                                            alt=""></a></td>
                                <!-- title -->
                            ...
                            <tr>
                                <!-- img -->
                                <td class="tp-cart-img"><a href="product-details.html"> <img
                                            src="{{ asset('/') }}website/assets/img/product/cart/product-cart-2.jpg"
                                            alt=""></a></td>
                                <!-- title -->
                            ...
                            <tr>
                                <!-- img -->
                                <td class="tp-cart-img"><a href="product-details.html"> <img
                                            src="{{ asset('/') }}website/assets/img/product/cart/product-cart-3.jpg"
                                            alt=""></a></td>
                                <!-- title -->
                            ...
                            <tr>
                                <!-- img -->
                                <td class="tp-cart-img"><a href="product-details.html"> <img
                                            src="{{ asset('/') }}website/assets/img/product/cart/product-cart-4.jpg"
                                            alt=""></a></td>
                                <!-- title -->
